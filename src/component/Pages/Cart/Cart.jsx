          ...
          <div className="w-full max-w-xs">
            <Card className="sticky top-8 p-4 border border-solid border-black">
              ...
              <div className="flex flex-row justify-between mt-2">
                ...
                <div className="font-bold text-red-600">-Rp 10.500</div>
              </div>
              ...
              <button className="w-full p-2 mt-4 rounded-10px bg-black font-bold text-center border-2 border-solid border-transparent text-white transition-all duration-200 hover:bg-transparent hover:border-black hover:text-inherit">
                Order Sekarang
              </button>
            </Card>
          </div>
